    ...
    try {
        ...
        const mailOptions = {
            ...
            html: `
                ...
                <p>
                    <a href="http://localhost:8080/approve/${requestId}" style="padding:10px;background:green;color:white;text-decoration:none;">Approve</a>
                    <a href="http://localhost:8080/deny/${requestId}" style="padding:10px;background:red;color:white;text-decoration:none;margin-left:10px;">Deny</a>
                </p>
            `
        };
